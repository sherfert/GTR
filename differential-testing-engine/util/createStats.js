...
/**
 * Using the JSON files that were created by server-reducer, this file creates two csv files,
...
(function () {
    ...
    var numAlgos = createCSV();
    var result = plot(numAlgos);
